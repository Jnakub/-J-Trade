...
# ตั้งแต่ 1R เป็น 100: ตอนนี้กฎที่ยังตัดจริงคือ Indicator ร้อน (75) กับ ใกล้ข่าว (50) และมันยิงได้
# ทุกช่วง R ไม่มีเพดานอะไรมาครอบอีก (Climax = 100 ปิดแล้ว, เดินทาง >=50% ไป TP = 100 ปิดแล้ว)
#
